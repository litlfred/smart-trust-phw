...
* link[+].extension[requestTrigger].valueMarkdown = """
...
* link[=].extension[responseTrigger].valueMarkdown = """Issuer has performed any necceasry document generation, digital signatures and has generated a VHL according to a content profile."""
