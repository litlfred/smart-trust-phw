...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:GraphDefinition/f:node">
      <sch:assert test="count(f:extension[@url = 'http://smart.who.int/trust-phw/StructureDefinition/SGActorExt']) &gt;= 1">extension with URL = 'http://smart.who.int/trust-phw/StructureDefinition/SGActorExt': minimum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
